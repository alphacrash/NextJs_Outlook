export const messages = [
  {
    ...
    message_id: "hr_msg1",
    snippet:
      "Hello, we've received your application for the Software Engineer role.",
  ...
  },
  {
    ...
    message_id: "hr_msg2",
    snippet:
      "We would like to move forward and schedule a first round interview. Are you available next week?",
    subject: "Software Engineer Application",
  ...
  },
  {
    ...
    message_id: "hr_msg3",
    snippet:
      "We're currently reviewing applications for the Marketing Manager position.",
  ...
  },
  {
    ...
    message_id: "hr_msg4",
    snippet:
      "We are impressed with your resume and would like to proceed with a brief phone interview. Would you be available on Thursday afternoon?",
    subject: "Marketing Manager Application",
  ...
  },
  {
    ...
    message_id: "hr_msg6",
    snippet:
      "We are interested in your profile for the Project Manager role. Could you please clarify some aspects of your experience?",
  ...
  },
  {
    ...
    message_id: "hr_msg7",
    snippet:
      "Could you provide more details on your experience with agile project management?",
    subject: "Project Manager Application",
  ...
  },
  {
    ...
    snippet:
      "Certainly, I have successfully led multiple projects using agile methodologies, with a focus on iterative development and team collaboration.",
    subject: "Project Manager Application",
  ...
  },
  {
    ...
    message_id: "hr_msg8",
    snippet:
      "Following your interview for the Data Analyst role, we'd like to request your professional references.",
  ...
  },
  {
    ...
    message_id: "hr_msg10",
    snippet:
      "We're pleased to inform you that you're moving forward in the selection process for the UX Designer position. We'd like to invite you for a final round interview.",
  ...
  },
  {
    ...
    snippet:
      "That's wonderful news. Thank you, I'm available for the final round interview.",
    subject: "UX Designer Application",
